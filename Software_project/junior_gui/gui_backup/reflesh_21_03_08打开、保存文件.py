...
# Form implementation generated from reading ui file 'original_11_24_wfh_2.ui'
#
...
class Ui_MainWindow(object):
    ...
    # 主窗口方法
    # def showDialog(self): # 打开文件
    #     fname = QFileDialog.getOpenFileName() # (self.actionOpen,'open file','/')  # fname = ('C:/Users/23573/Desktop/树莓派配置.txt', 'All Files (*)')
    #     if fname[0]:
    #         try:
    ...
    # def savefile(self):
    #     fname = QFileDialog.getSaveFileName("文件保存", "./", "All Files (*);;Text Files (*.txt)")
    #     print(fname)
